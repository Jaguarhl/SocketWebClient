...
import ru.kartsev.dmitry.socketwebclient.presenter.impl.TournamentInfoPresenter;
...
public class FrameTournamentsList extends BaseFragment implements ITournamentInfoPresenter {
    private ITournamentInfoPresenter presenter = new TournamentInfoPresenter(this,
